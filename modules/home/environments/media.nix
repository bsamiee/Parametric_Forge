...
# Media and document processing environment variables
{
  ...
  fontDirectories =
    lib.optionals (host.os == "darwin") [
      ...
      "${config.home.homeDirectory}/Library/Application Support/design-tools/fonts/owned"
      "${config.home.homeDirectory}/Library/Application Support/design-tools/fonts/google/source-sans-3"
    ]
