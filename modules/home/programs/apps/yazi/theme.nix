...
# highlighting consumes the owner's shared tmTheme artifact
{config, ...}: let
...
in {
  xdg.configFile."yazi/theme.toml".text = ''
    ...
    [icon]
    prepend_dirs = [
      { name = ".git", text = "󰊢", fg = "${p.pink.hex}" },
      { name = "node_modules", text = "󰏗", fg = "${p.green.hex}" },
      { name = "target", text = "󰀘", fg = "${p.magenta.hex}" },
      { name = ".venv", text = "󰅩", fg = "${p.yellow.hex}" },
      { name = "__pycache__", text = "󰌠", fg = "${p.yellow.hex}" },
      { name = ".config", text = "", fg = "${p.purple.hex}" },
      { name = ".ssh", text = "", fg = "${p.pink.hex}" },
      { name = "src", text = "󰈙", fg = "${p.cyan.hex}" },
      { name = "bin", text = "󰞰", fg = "${p.green.hex}" },
    ]
