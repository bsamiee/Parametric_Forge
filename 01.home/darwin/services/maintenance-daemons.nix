# Title         : maintenance-daemons.nix
# Author        : Bardia Samiee
# Project       : Parametric Forge
# License       : MIT
# Path          : /01.home/darwin/services/maintenance-daemons.nix
# ----------------------------------------------------------------------------
# Home maintenance daemons: runtime cleanup, cache management, font cache, and npm updates.
