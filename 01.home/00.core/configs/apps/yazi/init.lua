...
-- Whoosh bookmarks configuration
...
-- Keyjump configuration with Dracula colors
require("keyjump"):setup({
	icon_fg = "#ff79c6", -- Dracula pink for visibility
	first_key_fg = "#50fa7b", -- Dracula green for first key
	go_table = {
		{ on = { "h" }, run = "cd ~", desc = "Go to home" },
		{ on = { "c" }, run = "cd ~/.config", desc = "Go to config" },
		{ on = { "d" }, run = "cd ~/Downloads", desc = "Go to downloads" },
		{ on = { "D" }, run = "cd ~/Documents", desc = "Go to documents" },
		{ on = { "p" }, run = "cd ~/Documents/99.Github", desc = "Go to projects" },
		{ on = { "P" }, run = "cd ~/Documents/99.Github/Parametric_Forge", desc = "Go to Parametric Forge" },
	},
})

-- Searchjump configuration with Dracula colors
require("searchjump"):setup({
	unmatch_fg = "#6272a4", -- Dracula comment (muted)
	match_str_fg = "#282a36", -- Dracula background (for contrast)
	match_str_bg = "#f1fa8c", -- Dracula yellow (highlight)
	first_match_str_fg = "#282a36", -- Dracula background (for contrast)
	first_match_str_bg = "#50fa7b", -- Dracula green (primary match)
	label_fg = "#282a36", -- Dracula background (for contrast)
	label_bg = "#ff79c6", -- Dracula pink (labels)
	only_current = false, -- Search all directories
	show_search_in_statusbar = true, -- Show in status bar for feedback
	auto_exit_when_unmatch = false, -- Stay in mode for better UX
	enable_capital_label = true, -- Use capitals for more options
})
