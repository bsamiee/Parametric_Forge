...
MCP manifest changes fan through `mcp-launchers.nix`, fleet serialization, generated wrappers, owned client projections, health probes, and drift checks. Required client rows additionally affect startup admission.
