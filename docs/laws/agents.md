...
Machine-surface law extending `design.md` onto supervised service agents: launchd rows and their Linux systemd twins. Apply when writing or reviewing any launchd or systemd user-service row; a finding cites the card it breaks.
