...
`shortcuts sign --mode anyone` notarizes through iCloud for open sharing and `--mode people-who-know-me` signs locally for contact-gated import; a hardened install imports a signed `.shortcut` alone.
