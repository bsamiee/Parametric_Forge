...
const LANES = [
    ...
    },
    {
        ...
        task: 'GOAL: build the Yazi modernization dossier (floating-popup-first redesign, current plugin ecosystem). ' +
            ...
            FORGE + '/modules/home/scripts/terminal.nix  and ' + FORGE + '/modules/home/scripts/terminal.nix  (forge-yazi.sh, forge-edit.sh, forge-nvim.sh sources — extract the full text of each with line numbers). ' +
    ...
    },
    {
        ...
        task: 'GOAL: design-ground the yazi->editor rail rebuild (current one is broken three ways: focus-next-pane hits yazi at startup, Nix-escaped \\$SOCKET/\\$* expand empty, ordinal focus is layout-dependent). ' +
            'LOCAL READS (extract full text with line numbers): ' + FORGE + '/modules/home/scripts/terminal.nix (forge-edit.sh, forge-nvim.sh), ' +
            FORGE + '/modules/home/scripts/terminal.nix  (forge-yazi.sh, any zoxide script), ' + FORGE + '/modules/home/programs/apps/yazi/yazi.toml (opener config), ' +
