...
### Local Provisioning
- `rasm-provision` is the canonical Rasm local provisioning command. The overlay package owns the implementation; Home Manager only installs that derivation.
