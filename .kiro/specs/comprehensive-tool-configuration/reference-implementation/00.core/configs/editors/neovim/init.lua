...
-- License       : MIT
-- Path          : 01.home/00.core/configs/editors/neovim/init.lua
-- ----------------------------------------------------------------------------
-- Neovim configuration with modern plugins and development optimizations
...
require("lazy").setup({
  ...
  -- Treesitter
  {
    ...
    build = ":TSUpdate",
    opts = {
      ensure_installed = { "bash", "c", "diff", "html", "lua", "luadoc", "markdown", "vim", "vimdoc", "rust", "python", "javascript", "typescript", "nix" },
      auto_install = true,
      highlight = {
        enable = true,
