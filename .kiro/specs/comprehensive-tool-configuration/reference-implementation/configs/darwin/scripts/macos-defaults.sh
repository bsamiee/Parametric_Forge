#!/usr/bin/env bash
# Title         : macos-defaults.sh
# Author        : Bardia Samiee
# Project       : Parametric Forge
# License       : MIT
# Path          : configs/darwin/scripts/macos-defaults.sh
# ----------------------------------------------------------------------------
# macOS system defaults configuration for development-focused setup
...
log_info "Configuring macOS system defaults for development..."
...
log_info "Configuring energy saving settings..."
...
# Hibernation mode
# 0: Disable hibernation (speeds up sleep & wake)
...
tell application "Terminal"
	...
	repeat with windowID in allOpenedWindows
		...
		(* Close the additional windows that were opened when
...
log_info "Configuring system applications..."
...
log_info "Applying settings that require restart..."
...
${GREEN}macOS Configuration Complete!${NC}

Your macOS system has been configured with development-focused settings:
- Enhanced Finder with hidden files and extensions visible
- Optimized Dock with auto-hide and development-friendly settings
- Fast keyboard repeat rates for efficient coding
- Disabled animations for better performance
- Enhanced security and privacy settings
- Developer-friendly Safari and Terminal configurations

${YELLOW}Note:${NC} Some changes require a restart to take full effect.
${YELLOW}Restart your Mac when convenient to apply all settings.${NC}
